---
type: encounter
tags: [encounter, index]
status: active
---

# Encounter Index

Quick reference for all encounters in the campaign.
...
### [[encounters/calico-boys-showdown|Calico Boys Showdown]]

| Creature | AC | HP | Attack | Damage |
|----------|----|----|--------|--------|
| Bandit (x4) | 12 | 11 | +3 | 1d10+1 (sparkpistol) or 1d6+1 (scimitar) |
| [[characters/npcs/joss-harlow\|Joss Harlow]] | 15 | 65 | +5 | 2d6+3 (sparkpistol) |

**Tactics**: Spread out, take cover. Surrender if 2+ killed.

---

### [[encounters/the-ambush|The Ambush]]
...
**Note**: [[characters/npcs/the-ashen-rider|The Rider]] cannot be harmed until PCs reach Stage 4.

---

### [[encounters/ashen-rider-finale|Ashen Rider Finale]]

| Creature | AC | HP | Attack | Damage |
|----------|----|----|--------|--------|
| [[characters/npcs/the-ashen-rider\|The Ashen Rider]] | 18 | 75 | +9 | 1d10+5 x3 per turn |

**Maneuvers**: Menacing Attack (DC 14 Wis), Precision Attack (+d8), Riposte, Disarming Attack (DC 14 Str)

---

### [[encounters/loom-frame-guardian|Loom Frame Guardian]]

| Creature | AC | HP | Attack | Damage |
|----------|----|----|--------|--------|
| Frame Warden (x2) | 18 | 33 | +4 | 1d6+2 x2 (slam) |

**Special**: Immune to psychic. Containment Field (DC 13 Dex, 2d6 force, restrained).
...
### Major Glitches (DC 15-17)
- Time freezes briefly
- Same person in two places
- Memory of something not yet done
- Horizon shimmers with geometry

### Scripted Glitches (No roll)
- [[sessions/session-01-arrival\|Session 1]]: Piano freeze, combat flashback, clock tower
- [[sessions/session-02-the-stray\|Session 2]]: Stagecoach repeat, [[characters/npcs/joss-harlow|Joss]] breakdown, Patron immunity
- [[sessions/session-03-the-spiral\|Session 3]]: Quieting failure
...
| Collapsing building | 2d6 bludgeoning | DC 13 Dex |
...
## Spiral Points by Encounter

| Encounter | Potential Points |
|-----------|------------------|
| [[encounters/calico-boys-showdown\|Calico Boys]] (combat flashback) | +1 |
| [[encounters/calico-boys-showdown\|Calico Boys]] (time freeze, if non-intervention) | +2 |
| [[encounters/glitch-events\|Piano glitch]] | +1 |
| [[encounters/glitch-events\|Clock tower freeze]] | +2 |
| [[encounters/the-ambush\|Witnessing Patron immunity]] | +3 |
| [[encounters/joss-harlow-stray\|Joss Harlow breakdown]] | +2 |
| [[encounters/the-ambush\|Death and reset]] | +5 |
| [[encounters/vanes-revelation\|Vane's revelation]] | +5 |
| [[encounters/vanes-revelation\|Choosing to awaken]] | +5 |
| [[encounters/ashen-rider-finale\|Rider negotiation success]] | +3 |

---

## Session Encounter Flow
